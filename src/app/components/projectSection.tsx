    ...
    >
      ...
      xl:flex-row lg:flex-row md:flex-row sm:flex-row bg-gray-50 jusify-center items-center">
        ...
        <div className="w-[90%] xl:w-[60%] lg:w-[60%] md:w-[60%] sm:w-[60%]  h-[90%] flex flex-col justify-evenly items-center  ">
          ...
          <div className="w-[90%]">
            <p className="text-[10px] xl:text-[14px] lg:text-[13px] md:text-[12px] sm:text-[11px] leading-[25px] xl:leading-[25px] lg:leading-[24px] md:leading-[23px] sm:leading-[22px]">Customer satisfaction is a vital indicator of how well a company’s products, services, and overall experience align with customer expectations. It's not merely about making customers happy—it's a key driver of business success. High satisfaction levels help retain customers, reduce churn, and foster brand loyalty, while also boosting revenue and profitability. Ultimately, effective customer service isn't based on assumptions; it’s about delivering what the customer truly values and experiences.</p>
          </div>
        </div>
      </div>
